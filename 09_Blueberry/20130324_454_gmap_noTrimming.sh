...
file="/lustre/groups/lorainelab/data/blueberry/dhmri_ONeal_454_run_2009_06_18/fastq/GI3MI6V01.fastq"
...
file="/lustre/groups/lorainelab/data/blueberry/dhmri_ONeal_454_run_2009_06_18/fastq/GI3MI6V02.fastq"
nice -n 19 gmap -D "/lustre/groups/lorainelab/sw/gmap/2013-05-09/share/454Scaffolds" -d '454Scaffolds' -f samse --intronlength=30000 --nthreads=$nthreads $file | nice -n 19 samtools view -bt "$ref_file".fai -| nice -n 19 samtools sort - "$file"_sorted 
echo 'completed the mapping for: '$file >>$LOGFILE

file="/lustre/groups/lorainelab/data/blueberry/ncsu_ONeal_454_Aug_2010/files_from_ncsu_gsl/fastq/onrip.fastq"
nice -n 19 gmap  -D "/lustre/groups/lorainelab/sw/gmap/2013-05-09/share/454Scaffolds" -d '454Scaffolds' -f samse --intronlength=30000 --nthreads=$nthreads $file | nice -n 19 samtools view -bt "$ref_file".fai -| nice -n 19 samtools sort - "$file"_sorted 
echo 'completed the mapping for: '$file >>$LOGFILE

file="/lustre/groups/lorainelab/data/blueberry/ncsu_ONeal_454_Aug_2010/files_from_ncsu_gsl/fastq/onunr.fastq"
nice -n 19 gmap  -D "/lustre/groups/lorainelab/sw/gmap/2013-05-09/share/454Scaffolds" -d '454Scaffolds' -f samse --intronlength=30000 --nthreads=$nthreads $file | nice -n 19 samtools view -bt "$ref_file".fai -| nice -n 19 samtools sort - "$file"_sorted 
echo 'completed the mapping for: '$file >>$LOGFILE
