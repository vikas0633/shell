...
SCRIPTDIR="/lustre/home/vgupta2/script"

cd /lustre/groups/lorainelab/data/blueberry/02_mergedBam/run2_6K
echo '----------------------------------------------' > $LOGFILE
...
file="Cufflinks_6K.gtf"
perl "$SCRIPTDIR"/perl/cufflinks_gtf_to_gff3.pl $file > $file.gff3
