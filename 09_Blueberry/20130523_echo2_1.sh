...
file="Loraine_110923HiSeqRun_Lane3_Sample_3-33_pad_combined.fastq_trimmed"

cp $file $file.fastq
file=$file.fastq
python /lustre/groups/lorainelab/sw/echo_v1_12/ErrorCorrection.py -b 2000000 --nh 4096 --ncpu 5 -o "$DATADIR/$file".corrected $DATADIR/$file
